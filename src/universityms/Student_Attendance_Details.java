...
public class Student_Attendance_Details extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		new Student_Attendance_Details();
	...
	public void actionPerformed(ActionEvent e) {
		...
		String query = "SELECT * from attendence_student where rollno =" + Integer.parseInt(roll) + " and datee='" + date + "';";
