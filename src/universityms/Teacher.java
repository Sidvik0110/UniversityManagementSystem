...
class Teacher extends JFrame implements ActionListener
{
    ...
    Teacher() {
        ...
        setLayout(null);
        final JLabel l1 = new JLabel("Enter employee id to view details of teacher");
        ...
        id8 = new JLabel("Teacher Details:");
    ...
    public void actionPerformed(final ActionEvent ae) {
        if (ae.getSource() == b) {
            try {
                ...
                str="update login set password='"+t10.getText()+"' where username=" + Integer.parseInt(t1.getText()) + ";";
                con.s.executeUpdate(str);
        ...
        if (ae.getSource() == b2) {
            try {
                final conn con = new conn();
                final String str = "select * from teacher where emp_id = " + Integer.parseInt(t12.getText()) + ";";
